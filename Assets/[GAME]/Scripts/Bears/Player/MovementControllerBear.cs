...
namespace _GAME_.Scripts.Bears.Player
{
    public class MovementControllerBear : Bear
    {
        ...
        private void Awake()
        {
            ...
            _horizontalSpeed = movementData.HorizontalSpeed;
            _horizontalClampRange = movementData.HorizontalClampRange;
            
            _canRotate = movementData.CanRotate;
            _rotationSpeed = movementData.RotationSpeed;
            _rotationPower = movementData.RotationPower;
            _rotationClampRange = movementData.RotationClampRange;
        }
